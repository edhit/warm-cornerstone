...
function app() {
    return {
        ...
        // ─────────────────────────────────────────────────────────────
        // ОТЗЫВЫ: та же логика редактирования, что и у сторис — просто
        // статичный массив, без API. Чтобы добавить отзыв, скопируйте один
        // объект и измените поля:
        // n — имя и город, c — что чистили, t — текст отзыва
        // photos — необязательно: массив путей к фото (скриншот переписки,
        //          фото результата и т.п.). Можно не указывать вовсе,
        //          указать одно фото или несколько — они появятся как
        //          маленькие превью под отзывом, и открываются по клику
        //          в полноэкранном просмотре, как сторис.
        // ─────────────────────────────────────────────────────────────
        reviews: [
            {
                n: "Анна, Москва",
        ...
        // ─────────────────────────────────────────────────────────────
        // СТОРИС: чтобы добавить/поменять фото — ничего в коде трогать
        // не нужно, кроме этого массива. Он статичный, без API.
        // 1) Положите фото в папку /img/stories/ (можно называть как угодно)
        // 2) Добавьте/измените "slides" у нужной истории — img: путь к файлу,
        //    desc: подпись, которая показывается внизу при просмотре
        // 3) title — подпись под кружком на сайте
        // Порядок историй = порядок кружков на сайте.
        // ─────────────────────────────────────────────────────────────
        stories: [
            {
                title: "Ковры",
                slides: [{ img: "/img/stories/001.jpg", desc: "Химчистка ковров — выводим пятна и восстанавливаем цвет ворса." }],
            },
            {
            ...
            {
                title: "Рестораны",
                slides: [{ img: "/img/stories/004.jpg", desc: "Химчистка мягкой мебели в кальянных и ресторанах." }],
            },
            {
                title: "Что мы умеем",
                slides: [{ img: "/img/stories/005.jpg", desc: "CODE — профессиональная химчистка мебели и текстиля." }],
            },
            {
                title: "Оборудование",
                slides: [{ img: "/img/stories/006.jpg", desc: "Работаем на профессиональных экстракторах для глубокой очистки." }],
            },
            {
            ...
            {
                title: "Шторы и тюли",
                slides: [{ img: "/img/stories/010.jpg", desc: "Химчистка штор и тюлей — работаем на выезде, без демонтажа." }],
            },
            {
                title: "Клининг",
                slides: [{ img: "/img/stories/011.jpg", desc: "Клининговые услуги — помещения любого размера." }],
            },
            {
                title: "Деликатные ткани",
                slides: [{ img: "/img/stories/012.jpg", desc: "Химчистка деликатных изделий: шёлк, бархат, дорогой текстиль." }],
            },
            {
                title: "Диваны",
                slides: [
